...
async def get_buying_list(message):
    with open("files/1.jpg", "rb") as img1:
        await message.answer_photo(img1, "Название: Протеин | Описание: Сывороточный | Цена: 100")
    with open("files/2.jpg", "rb") as img2:
        await message.answer_photo(img2, "Название: Standart.Казеин | Описание: Сывороточный | Цена: 200")
    with open("files/3.jpg", "rb") as img3:
        await message.answer_photo(img3, "Название: Whey.Протеин | Описание: Соевый | Цена: 300")
    with open("files/4.jpg", "rb") as img4:
        await message.answer_photo(img4, "Название: Nutrend.Протеин | Описание: Сбалансированный | Цена: 400")
